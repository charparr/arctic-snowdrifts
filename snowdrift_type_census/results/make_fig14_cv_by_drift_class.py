...
ax = sns.scatterplot(x='Class', y='CV Depth', hue='Swath', style='Swath',
	data=df, palette=current_palette)

plt.savefig('../../figs/f14_cv_by_drift_class_300.png', dpi=300, bbox_inches='tight')

plt.savefig('../../figs/f14_cv_by_drift_class_600.png', dpi=600, bbox_inches='tight')
